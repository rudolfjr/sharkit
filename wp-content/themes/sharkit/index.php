...
<meta charset="utf-8" />
    <link rel="shortcut icon" href="/wp-content/themes/sharkit/favicon.ico" />
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/sharkit in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/sharkit) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/sharkit/favicon.ico" will
        work correctly both with client-side routing and a non-root public URL.
        Learn how to configure a non-root public URL by running `npm run wpbuild`.
    -->
    <title>React WordPress Theme</title>
<link href="/wp-content/themes/sharkit/static/css/main.chunk.css?15fbebe4abd80033914a" rel="stylesheet"></head>
    <body>
    <noscript>
    ...
    -->
    <script src="/wp-content/themes/sharkit/static/js/bundle.js?15fbebe4abd80033914a"></script><script src="/wp-content/themes/sharkit/static/js/1.chunk.js?15fbebe4abd80033914a"></script><script src="/wp-content/themes/sharkit/static/js/main.chunk.js?15fbebe4abd80033914a"></script></body>
</html>
